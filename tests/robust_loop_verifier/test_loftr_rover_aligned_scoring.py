...
from baseline_scripts.score_loftr_rover_aligned_benchmark import (
    LoFTRMatchResult,
    RansacConfig,
...
class _FakeMatcher:
    ...
    def match(self, query_image: Path, candidate_image: Path) -> LoFTRMatchResult:
        ...
        count = 12 if candidate_image.name == "candidate_a.png" else 7
...
def _fake_ransac(mkpts0, mkpts1, config):
    return {
        ...
        "num_inliers": 5,
        "inlier_ratio": 5.0 / float(len(mkpts0)),
    }
