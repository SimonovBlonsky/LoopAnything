#!/usr/bin/env bash
# =============================================================================
# Automated Cambridge training-free baseline ablation
#
# 3 retrieval backends × 2 pose paths × 5 scenes = 30 experiments
...
#   bash run_all_cambridge_ablation.sh
# =============================================================================
...
CSV_FILE="baseline_cambridge_results.csv"
